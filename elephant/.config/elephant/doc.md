...
`~/.config/elephant/bitwarden.toml`
#### Config
| Field | Type | Default | Description |
| --- | ---- | ---- | --- |
...
|clear_after|int|5|clipboard will be cleared after X seconds. 0 to disable.|
|copy_command|string|wl-copy --sensitive --|clipboard copy command to be executed. supports %VALUE%.|
|clear_command|string|wl-copy --clear|clipboard clear command to be executed.|
|autotype_support|bool|false|enable autotype support|
|autotype_command|string|wtype -- %VALUE%|copy command to be executed. supports %VALUE%.|
|autotype_delay|int|500|delay autotype for X milliseconds. 0 to disable.|
